...
tree::tree() {
    ...
    // creates pointer for new connectFourBoard object
    ob = new connectFourBoard();
}
...
bool tree::deep_enough(int depth) {
    ...
    else if (depth == 5 || ob->checkPlayerWon()) {
...
*/
void tree::copy_board_status(connectFourBoard &tc) {
